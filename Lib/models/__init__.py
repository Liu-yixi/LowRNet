...
def build_model(cfg):
    ...
    elif cfg.MODEL.NAME == 'fwnet18':
        from Lib.models.fwnet import FWNet18
        print("FWNet34, only first layer replaced with lrc layer")
        model = FWNet18(num_classes=cfg.MODEL.NUM_CLASSES, cfg=cfg)
        
    elif cfg.MODEL.NAME == 'fwnet34':
        from Lib.models.fwnet import FWNet34
        print("FWNet34, only first layer replaced with lrc layer")
        model = FWNet34(num_classes=cfg.MODEL.NUM_CLASSES, cfg=cfg)
